...
import com.example.catatan10120159.databinding.DialogDetailCatatanBinding
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import java.text.SimpleDateFormat
import java.util.Calendar

class DetailCatatanDialog(
    ...
    private fun saveData() {
        ...
        if (binding.etNoteTitle.text.isNotEmpty() && binding.etCategory.text.isNotEmpty() && binding.etNoteBody.text.isNotEmpty()) {
            ...
            Toast.makeText(
                requireContext(),
                "Judul, Kategory, dan catatan tidak boleh kosong!!!",
                Toast.LENGTH_SHORT
            ).show()
        }
    }
